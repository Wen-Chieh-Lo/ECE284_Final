module corelet(
    ...
    wire [psum_bw*col-1:0] flush_out;
    ...
    genvar i;
    wire [psum_bw-1:0] temp [0:col-1];
    for (i = 0; i < col; i = i + 1)begin
	assign temp[i]= (flush==1'b1) ? flush_out[psum_bw*(i+1)-1:psum_bw*i] : psum_accum_in[psum_bw*(i+1)-1:psum_bw*i];
