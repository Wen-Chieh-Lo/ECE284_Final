...
initial begin
  ...
  mode_q = 1;
  run_sim_2bit_test("txt_files_2bit/activation.txt", "txt_files_2bit/weight", "txt_files_2bit/output.txt");
  $finish;
end
...
task run_sim_2bit;
  ...
  for (kij=0; kij<9; kij=kij+1) begin  // kij loop
    ...
    for (t=0; t<col; t=t+1) begin  
      ...
      // Write ODD weights right after EVEN, contiguous in memory
      D_xmem = D_xmem_odd;
      WEN_xmem = 0; CEN_xmem = 0;
      #0.5 clk = 1'b1;   // write
      #0.5 clk = 1'b0;
